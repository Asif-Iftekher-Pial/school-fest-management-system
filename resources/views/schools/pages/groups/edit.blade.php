	...
	<div class="row">
		...
		<div class="col-9">
			<div class="m-3">
				...
				<div class="row my-3">
					<div class="col-12">
						<h5> <u>Event student group edit</u></h5>
					</div>
					<div class="col-12">
						@if ($errors->any())
				...
				<form action="{{ url('/student-groups/update/'.$data->id) }}" method="Post" enctype="multipart/form-data" accept-charset="UTF-8">
					{{ method_field('PATCH') }}
					{{ csrf_field() }}
						...
						<div class="col-6">
							...
							<div class="form-group">
							    ...
							    <select class="form-control demo3" name="group_id">
							        <option value="{{ $data->group_id }}">{{ $data->group->title }}</option>
							    </select>
							</div>
						</div>
						<div class="col-6">

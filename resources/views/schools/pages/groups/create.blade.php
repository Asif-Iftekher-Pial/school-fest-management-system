	...
	<div class="row">
		...
		<div class="col-9">
			<div class="m-3">
				<div class="row">
					<div class="col">
						<a class="btn btn-sm btn-primary mb-3" href="{{ url('/student-groups') }}">Back</a>
					</div>
				</div>
				<div class="row my-3">
					<div class="col-12">
						<h5> <u>Event student group create</u></h5>
					</div>
					<div class="col-12">
						@if ($errors->any())
				...
				<form action="{{ url('/student-groups/store') }}" method="Post" enctype="multipart/form-data" accept-charset="UTF-8">
					{{ csrf_field() }}
					<div class="row">
						<div class="col-6">
							...
							<div class="form-group">
							    ...
							    <select class="form-control demo3" name="group_id">
						...
						<div class="col-6">
							<div class="form-group">
							    <label for="title">Group Name / Title</label>
							    <input type="text" class="form-control" id="title" name="title" placeholder="Student Group Name">
							</div>
							<div class="form-group">
